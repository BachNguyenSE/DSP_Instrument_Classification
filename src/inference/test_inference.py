# test_inference.py (moved to inference/test_inference.py)
...
from dsp.dsp import design_bandpass_fir, apply_filter
from dsp.features import build_feature_vector
...
def main():
    # Cho phép: python3 -m src.inference.test_inference path/to/file.wav
    if len(sys.argv) == 2:
